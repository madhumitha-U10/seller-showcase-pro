...
export const uploadProductImage = (file: File) =>
  uploadToBucket("product-images", file, { maxSide: 1200, quality: 0.82, maxBytes: 10 * 1024 * 1024 });

/** Story / editorial photo. */
export const uploadStoryImage = (file: File) =>
  uploadToBucket("story-images", file, { maxSide: 1600, quality: 0.82, maxBytes: 10 * 1024 * 1024 });
